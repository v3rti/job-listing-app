...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-40 relative">
      <img className="bg-primary h-40 w-full" src="images/bg-header-desktop.svg" alt=""/>
      ...
      <div className="w-full h-full absolute top-8 left-0 flex justify-center items-end">
        <div className="bg-white h-14 text-lg w-9/12 shadow-xl rounded-lg px-6 flex items-center justify-between gap-4">
        <input className="px-4 py-2 w-full rounded-lg text-base focus:outline-none" type="text" placeholder="Search a job"/>
